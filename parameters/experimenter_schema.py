...
def get_full_schema():
    ...
    for preprocess in preprocesses_mapping:
        schema = {
            "properties": {
                "name": {
                    "error_msg": "Los preprocesamientos deben ser alguno de los "\
            ...
            "if": {
                "properties": {"name": {"const": preprocess}}
            },
            "then": {
                ...
                "properties": {
                    ...
                    "tokenizers": {
                        "oneOf": [
                                {
                                    "error_msg": "Los tokenizers debe ser alguno(s) de "\
                                ...
                                {
                                    "items": {
                                        "error_msg": "Los tokenizers deben ser alguno(s) de "\
            ...
            "then": {
                ...
                "properties": {
                    ...
                    "preprocesses": {
                        ...
                        {
                            "type": "object",
                            "error_msg": "Los preprocesamientos deben ser entregados como diccionario "\
    ...
    experimenter_schema = {
        "error_msg": "Las llaves del diccionario deben ser 'models', 'datasets' "\
                        "'metrics' y 'taks'.",
        "type": "object",
        "properties": {
            "models": {
                "type": ["array", "object"],
                "error_msg": "Los modelos deben ser entregados como diccionario "\
                                "individual, o como una lista de diccionarios.",
                "oneOf": [
                    {
                        "type": "object",
            ...
            "metrics": {
                ...
                "properties": {
                        ...
                        "oneOf": [
                            {
                                "type": "integer",
                                "minimum": 0,
                                "error_msg": "La label a optimizar debe ser el "\
                            ...
                            {
                                "type": "string",
                                "enum": ["global", "micro avg", "macro avg",
                                            "samples avg", "weighted avg"],
                                "error_msg": "La label a optimizar debe ser el "\
                                                "índice de la label (partiendo desde "\
                                                "0), o alguna de ['global', 'micro avg', "\
                                                "'macro avg', 'weighted avg', "\
                    ...
                    "best_n": {
                        ...
                        "default": 1,
                        "minimum": 0,
                        "error_msg": "El número de resultados a probar debe ser "\
                ...
                "allOf": [
                    {
                    "if": {
                        "properties": {"optimizer_label": {"const": "global"}}
                        },
                    "then": {
                        "properties": {
                            "optimizer_metric": {
                                "const": "accuracy",
                                "error_msg": "Global funciona con accuracy."
                                }
                            }
                        }
                    },
                    ...
                    "then": {
                        "properties": {
                            "optimizer_label": {
                                "const": "global",
                                "error_msg": "Accuracy no reconoce la label "\
            ...
            "task": {
                "error_msg": "task debe ser 'multilabel', 'multiclass' o 'binary'.",
                "type": "string",
